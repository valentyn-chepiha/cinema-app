...
public class MovieSessionController {
    ...
    @ApiOperation(value = "Create a new movie sessions")
    @PostMapping
    ...
    @ApiOperation(value = "Get a list of available movie sessions")
    ...
    @ApiOperation(value = "Update a movie session")
    @PutMapping("/{id}")
    ...
    @ApiOperation(value = "Delete a movie session")
    @DeleteMapping("/{id}")
